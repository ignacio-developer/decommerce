        ...
        if (! empty($offices)) {
            ...
            foreach ($offices as $office) {
                ...
                CarrierEcontOffice::create([
                    ...
                    'normal_business_hours_from' => isset($validated['normalBusinessHoursFrom'])
                        ? Carbon::createFromTimestampMs($validated['normalBusinessHoursFrom'], 'Europe/Sofia')->format('H:i:s')
                        : null,

                    'normal_business_hours_to' => isset($validated['normalBusinessHoursTo'])
                        ? Carbon::createFromTimestampMs($validated['normalBusinessHoursTo'], 'Europe/Sofia')->format('H:i:s')
                        : null,

                    'half_day_business_hours_from' => isset($validated['halfDayBusinessHoursFrom'])
                        ? Carbon::createFromTimestampMs($validated['halfDayBusinessHoursFrom'], 'Europe/Sofia')->format('H:i:s')
                        : null,

                    'half_day_business_hours_to' => isset($validated['halfDayBusinessHoursTo'])
                        ? Carbon::createFromTimestampMs($validated['halfDayBusinessHoursTo'], 'Europe/Sofia')->format('H:i:s')
                        : null,
